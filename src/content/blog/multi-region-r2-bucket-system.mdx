...
pubDate: 2024-05-26
shortDescription: Cheap, fast global file downloads via Cloudflare R2 mirrors
description: >-
  A Cloudflare Workers system that mirrors large files across R2 buckets in
  five regions and routes each download to the nearest bucket using
  geolocation-based distance calculations, with multipart uploads, Bearer
  token auth via Upstash Redis, and a cost breakdown showing roughly $15 per
  month per terabyte versus $500 on AWS S3.
category: projects
keywords:
  - CloudflareR2
  - MultiRegionStorage
  ...
  - GlobalFileDistribution
heroImage: ../../assets/images/multi-region/home.png
heroImageAlt: "Title card for the multi-region R2 bucket system on Workers"
---
