...
pubDate: 2025-04-27
shortDescription: How Italy and Spain's piracy crackdowns broke the wrong sites.
description: >-
  An examination of how anti-piracy IP-blocking laws in Italy and Spain have
  knocked legitimate websites offline by targeting shared cloud
  infrastructure. Details Italy's "Piracy Shield" system run by AGCOM,
  including the February 2024 incident where a single Cloudflare IP block
  took down tens of thousands of unrelated sites and a mistaken Google Drive
  disruption. Covers Spain's LALIGA-driven blocking of IPs used by Vercel,
  Cloudflare, GitHub Pages, and BunnyCDN during match days, Vercel's public
  criticism of the "indiscriminate" enforcement lacking SNI-based targeting,
  and the dismissed legal challenges, ending with a call for more
  proportionate, technically sound enforcement.
category: articles
keywords:
  - Internet Censorship
  - Anti-Piracy
