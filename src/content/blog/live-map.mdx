...
shortSlug: lv3m4p
pubDate: 2024-10-09
shortDescription: An interactive real-time world map of live visitors
description: >-
  Live Map is an interactive world map showing real-time visitor locations
  and country-level stats, built with react-simple-maps, MongoDB, and
  Cloudflare Workers/KV. Covers data collection, high-resolution map
  performance optimization, an FPS monitoring overlay, live location updates
  via Cloudflare instead of WebSockets, and Recharts-powered visitor
  analytics.
category: projects
keywords:
  - Interactive
  ...
  - Performance
  - Visualization
heroImage: ../../assets/images/live-map/home.png
heroImageAlt: "The Live Map home page and its interactive world map"
---
...
![Data Collection Diagram](../../assets/images/live-map/data-collection-diagram.png)
...
![Interactive World Map](../../assets/images/live-map/interactive-world-map.png)
...
![FPS Counter Example](../../assets/images/live-map/fps-counter-example.png)
...
![User Location Visualization](../../assets/images/live-map/user-location-visualization.png)
