...
pubDate: 2024-12-08
shortDescription: Gemini Nano lets Chrome run AI locally in the browser.
description: >-
  Chrome's built-in AI, powered by Gemini Nano, brings local, on-device AI
  processing to the web through Task APIs like Translator and Summarizer and
  Exploratory APIs like Prompt, covering the benefits, hybrid architecture,
  and how developers can get started.
category: articles
keywords:
  - Chrome
  - AI
...
_Note: These features are experimental and subject to change based on developer feedback and technological advancements._
