...
title: Archive Space
pubDate: 2024-09-27
shortDescription: A self-hostable cloud storage app on Cloudflare R2.
description: >-
  Archive Space is an open-source, self-hostable cloud storage platform built
  on Cloudflare R2, Next.js, Hono, and MongoDB, offering multi-region
  performance, data sovereignty, and a cost-effective alternative to Google
  Drive and similar services.
category: projects
keywords:
  - CloudStorage
  - SelfHosted
  ...
  - OpenSource
  - DataPrivacy
heroImage: ../../assets/images/archive-space/home.png
heroImageAlt: "The Archive Space title card: Simple Archive with Cloudflare R2"
---
...
![Archive Space](../../assets/images/archive-space/data-archive.png)
...
![Hono Js](../../assets/images/archive-space/hono.png)
