...
pubDate: 2024-11-04
shortDescription: A new indicator flags posts written with AI help.
description: >-
  I added an "AI Assistance" indicator to articles co-written with AI tools,
  explaining why transparency matters, how the feature works, and what it
  means for the authenticity of my content going forward.
category: updates
keywords:
  - AI Transparency
  - Blog Update
