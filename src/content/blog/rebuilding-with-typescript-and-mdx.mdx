...
pubDate: 2025-10-21
shortDescription: How I rebuilt my portfolio in strict TypeScript
description: >-
  A full rebuild of my portfolio covering three major migrations: moving
  content from next-mdx-remote to @next/mdx for build-time compilation and
  typed metadata, swapping next/og for the Rust-powered
  @takumi-rs/image-response to generate faster, crisper OG images on the
  Edge, and converting the entire codebase from JavaScript to strict
  TypeScript, including enforcing a typed Post schema and narrowing unions
  at the React Server Components boundary.
category: updates
keywords:
  - TypeScript
  - Next.js
  ...
  - portfolio
  - migration
heroImage: ../../assets/images/portfolio/new-dynamic-og.png
heroImageAlt: "The redesigned dynamic Open Graph social image"
---

After a year of incrementally tweaking my portfolio, I rebuilt it end-to-end. This post covers what changed, why I migrated content from [`next-mdx-remote`](https://github.com/hashicorp/next-mdx-remote) to [`@next/mdx`](https://github.com/vercel/next.js/tree/canary/packages/next-mdx), why I replaced [`next/og`](https://github.com/vercel/next.js/tree/canary/packages/next#imageresponse) with [`@takumi-rs/image-response`](https://github.com/kane50613/takumi), and the real challenges I hit moving the whole codebase from JavaScript to TypeScript.

In short: MDX moved in-tree with [`@next/mdx`](https://github.com/vercel/next.js/tree/canary/packages/next-mdx), social images now run on the Edge via [`@takumi-rs/image-response`](https://github.com/kane50613/takumi), and the app is fully typed under strict TypeScript.
...
If you're planning a similar migration, go incremental: type the content pipeline first, migrate shared utilities next, then flip strict and fix what shakes loose. And if social images matter, [`@takumi-rs/image-response`](https://github.com/kane50613/takumi) is an easy win when you're already at the Edge.
