...
pubDate: 2025-10-23
shortDescription: UV crushes pip on speed, env setup, and dependency resolution.
description: >-
  UV is Astral's Rust-based drop-in replacement for pip, pip-tools, and
  virtualenv, installing dependencies up to 15x faster in real-world tests.
  I cover its integrated environment management, smarter dependency
  resolution, automatic lockfiles for reproducible builds, and how easy it
  is to migrate existing pip projects over.
category: articles
keywords:
  - UV
  - Python
...
import light from "../../assets/images/uv/uv-light.jpg";
import dark from "../../assets/images/uv/uv-dark.jpg";
