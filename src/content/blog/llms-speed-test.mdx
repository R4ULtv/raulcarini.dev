...
pubDate: 2025-02-01
shortDescription: Snappy benchmarks how fast your local Ollama models run
description: >-
  Snappy is a web app that benchmarks local LLMs running through Ollama,
  running easy/medium/difficult prompts to measure tokens-per-second and
  other speed metrics on your own hardware, so you can compare models
  instead of guessing which one performs best on your machine.
category: projects
keywords:
  - LLM
  - Benchmark
  ...
  - AI
  - Local Models
heroImage: ../../assets/images/llms-speed-test/og-image.png
heroImageAlt: "Snappy's title card, listing the local models it benchmarks"
---
...
![Ollama](../../assets/images/llms-speed-test/ollama.png)
...
![Snappy - Deepseek-R1:1.5b](../../assets/images/llms-speed-test/deepseek-r1.png)
