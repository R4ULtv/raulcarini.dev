...
pubDate: 2024-09-13
shortDescription: Inside my Next.js and MDX portfolio-blog build
description: >-
  A behind-the-scenes look at building this Next.js 14 portfolio and blog,
  covering why MDX was chosen for content, how frontmatter and posts are
  parsed and rendered with next-mdx-remote, the tradeoffs against @next/mdx,
  a Redis-powered page view counter with Upstash, using Partial Prerendering
  to mix static and dynamic content, adding a Resend-powered newsletter, and
  tracking stats with Cloudflare Analytics.
category: projects
keywords:
  - NextJS
  - WebDevelopment
  ...
  - DeveloperPortfolio
heroImage: ../../assets/images/portfolio/home.png
heroImageAlt: "The raulcarini.dev title card, back when it ran on Next.js"
---

import TwitterBadge from "../../components/content/TwitterBadge.astro";
...
To create this website I was inspired by three other blogs/portfolios created by <TwitterBadge username="shuding_" />, <TwitterBadge username="emilkowalski_" /> and <TwitterBadge username="leerob" />.
...
![upstash redis](../../assets/images/portfolio/upstash-redis.jpg)
...
![next js ppr](../../assets/images/portfolio/thinking-in-ppr.png)
...
![resend](../../assets/images/portfolio/resend.png)
...
![cloudflare analytics](../../assets/images/portfolio/cloudflare-analytics.png)
