...
shortSlug: prdctn
pubDate: 2025-04-24
shortDescription: Next.js 15.3 brings Turbopack to production builds, in alpha.
description: >-
  Next.js 15.3 introduces an alpha of `next build --turbopack`, extending
  Turbopack's Rust-based speed from dev servers to production builds. With
  99.3% of integration tests passing and benchmarks showing up to 83% faster
  builds on 30 CPU cores, it's a promising but not yet production-ready
  successor to Webpack—best tried in staging while ecosystem tools like
  Sentry catch up.
category: articles
keywords:
  - Turbopack
