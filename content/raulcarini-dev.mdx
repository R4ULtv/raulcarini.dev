...
<Image src={"/assets/portfolio/home.png"} width={720} height={405} alt="raulcarini.dev" priority />
...
<a href="https://upstash.com/" target="_blank">
  <Image src={"/assets/portfolio/upstash-redis.jpg"} width={720} height={405} alt="upstash redis" />
</a>
...
<a
  ...
  target="_blank"
>
  <Image src={"/assets/portfolio/thinking-in-ppr.png"} width={720} height={405} alt="next js ppr" />
</a>
...
<a href="https://resend.com" target="_blank">
  <Image src={"/assets/portfolio/resend.png"} width={720} height={405} alt="resend" />
</a>
