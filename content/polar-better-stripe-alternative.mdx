export const metadata = {
  ...
  description: "Payments, memberships, and perks for indie devs and OSS - without the glue.",
  keywords: "Polar, Stripe, Payments, Sponsorships, Subscriptions, OSS, Indie SaaS",
};

<a href="https://polar.sh/" target="_blank">
  <Image src={"/assets/polar/og-image.jpg"} width={720} height={405} alt="Polar.sh" priority />
</a>
...
<a href="https://polar.sh/docs/integrate/webhooks/events" target="_blank">
  <Image src={"/assets/polar/webhooks.jpeg"} width={720} height={405} alt="Polar webhooks" />
</a>
...
<a href="https://polar.sh/resources/pricing" target="_blank">
  <Image src={"/assets/polar/fees-example.png"} width={720} height={405} alt="Polar fees example" />
</a>
