...
export const metadata = {
  ...
  description: "Why Bun’s speed and simplicity make it the future of JavaScript runtimes.",
  keywords: "Bun, JavaScript, Runtime, Node.js, Package Management, Performance",
};

<a href="https://x.com/bunjavascript" target="_blank">
  <Image src={"/assets/bun/bun.png"} width={720} height={405} alt="Bun" priority />
</a>
