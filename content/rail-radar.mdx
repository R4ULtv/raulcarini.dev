export const metadata = {
  ...
  description:
    "Real-time tracking of trains across 7 European countries with an interactive map powered by official railway data.",
  keywords:
    "real-time tracking, European trains, RFI data, Deutsche Bahn, National Rail, iRail, NS, Digitraffic, Cloudflare Workers, Next.js, Mapbox, monorepo, Hono framework, interactive maps, railway tracking, serverless API",
};
